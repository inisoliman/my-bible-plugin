...
function my_bible_ajax_error_response($message, $status_code = 400, $error_code_str = 'ajax_error') { /* ... كما كانت ... */ }
...
function my_bible_get_verses_ajax() {
    ...
    $meta_description_for_ajax = !empty($first_verse_text_for_meta) ? esc_html(wp_trim_words($first_verse_text_for_meta, 30, '...')) : sprintf(esc_html__('اقرأ الكتاب المقدس، %s الأصحاح %d.', 'my-bible-plugin'), esc_html($book_name_input), $chapter_number);
